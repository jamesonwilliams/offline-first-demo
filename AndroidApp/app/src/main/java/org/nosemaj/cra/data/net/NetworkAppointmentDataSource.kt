...
class NetworkAppointmentDataSource @Inject constructor(private val service: AppointmentService) {
    suspend fun listAppointments(page: Int): Result<AppointmentListResponse> = fetch(
    ...
    suspend fun getAppointment(appointmentId: Int): Result<AppointmentModel> = fetch(
